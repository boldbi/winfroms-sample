...
| EmbedSecret    | Get your EmbedSecret key from the Embed tab by enabling the `Enable embed authentication` on the Administration page. For more details: [Embed settings](https://help.boldbi.com/embedded-bi/site-administration/embed-settings/)     |
